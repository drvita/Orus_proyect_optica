...
<html lang="es">
  <head>
    ...
    <title>Orus || sistema administrativo</title>
  </head>
    ...
    @if (is_dir($ruta))
        ...
        @while ( ($archivo = readdir($gestor)) !== false)
            @if (preg_match("/.+.chunk.js$/im", $archivo))
                <script src="/{{$ruta}}/{{$archivo}}"></script>
            @endif
        @endwhile
