        ...
        @while ( ($archivo = readdir($gestor)) !== false)
            @if (preg_match("/.+\.chunk.js$/im", $archivo))
              @php
                  $file = $ruta . $archivo;
                  // Log::debug($file);
                  $time = date('Ymdhi', filectime($file));
              @endphp
