...
RUN docker-php-ext-install pdo_pgsql pgsql bcmath gd zip intl pcntl opcache
...
# Copy necessary directories for autoloader generation
COPY app ./app
...
# Install dependencies without generating autoloader
...
# Clear and optimize Laravel (if needed, though some might prefer this in build)
